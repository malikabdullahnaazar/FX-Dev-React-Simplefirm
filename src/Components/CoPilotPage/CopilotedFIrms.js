...
const CopilotedFIrms = ({firms,loading}) => {
          ...
          <tbody>
            ...
            firms?.map((firm, index) => (
              ...
              >
                ...
                <td>
                  {firm?.for_firm?.attorneyprofile?.office_name || ""}
                  <br />
                  {firm?.for_firm?.main_contact[0] && (
                    <TableAddress fullAddress={firm?.for_firm?.main_contact[0]} />
                  )}
                </td>
                <td>
                {firm?.for_firm?.main_contact?.length > 0 && (
                     <>
                {firm?.for_firm?.main_contact[0]?.phone_number ? (
                      <>
                        ({firm?.for_firm?.main_contact[0].phone_number?.slice(0, 3)}){" "}
                        {firm?.for_firm?.main_contact[0].phone_number?.slice(3, 6)}-
                        {firm?.for_firm?.main_contact[0].phone_number?.slice(6)}
                        {firm?.for_firm?.main_contact[0]?.phone_ext && (
                    ...
                    <br />
                    {firm?.for_firm?.main_contact[0]?.fax ? (
                      <>
                        ({firm?.for_firm?.main_contact[0].fax.slice(0, 3)}) {firm?.for_firm?.main_contact[0].fax.slice(3, 6)}-
                        {firm?.for_firm?.main_contact[0].fax.slice(6)} - <b>fax</b>
                      </>
                    ) : (
                      <span className="text-grey">(###) ###-####</span>
                    )}
                    <br />
                    {firm?.for_firm?.main_contact[0]?.email && firm?.for_firm?.main_contact[0]?.email != "nan" ? (
                      firm?.for_firm?.main_contact[0]?.email
                    ) : (
                      <span className="text-grey">someone@example.com</span>
                    )}
                    <br />
                    {(firm?.for_firm?.main_contact[0]?.website && (
                      <a
                        href={firm?.for_firm?.main_contact[0].website}
                        target="_blank"
