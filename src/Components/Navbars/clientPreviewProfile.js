//this profile file is primarily for client portal
...
const NavbarProfileClient = () => {
  ...
  const displayRecentCases = () => {
    ...
    console.log("div Node ==>", divToRemove);
  ...
  return (
    <>
      ...
      {showRecentCases ? (
        <div
          className="previous-client wid-0-new right-in"
          id="previous-client"
          ref={dropdownRef}
          style={{
        ...
        >
          {isLoading ? (
            ...
            lastAccessedCases?.map((temp) => (
              <div
                className="d-flex flex-column users-incident-popup"
                key={temp.id}
              >
                <a
                  href="#"
                ...
                <div className="client-details">
                  <div className="client-details-wrap-area  d-flex align-items-center text-decoration-none">
                    <div className="client-image position-relative">
                      <a
                        href={
                          page
                    ...
                    <div className="client-info overflow-hidden col p-0 h-100">
                      <div className="client-name d-flex align-items-center">
                        <a
                          href={
                            page
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        <a
                          ...
                          className="js-acc-btn text-black accident-type d-flex align-items-center  client_phone_header text-decoration-none"
                        >
                ...
                <div className="check-detail-items p-l-15 p-b-5 ">
                  <div className="check-detail-items_wrap">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="d-flex m-r-15">
                        <div
                          style={{ marginRight: "-2px" }}
