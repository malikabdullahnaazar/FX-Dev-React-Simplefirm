...
function DisabilityLien({ object }) {
  ...
  const contact = object?.disability_lien_contact || {};
    ...
    <div className="info-div employment-divs">
      <div className="p-l-5 text-capitalize">
        <div>
          ...
          {contact.name ? (
            <p className="inline-row-h-21 fs-14">{contact.name}</p>
          ) : (
            <p className="text-primary-50 fs-14">Full Name</p>
          )}
          <div className="fs-14">
            {contact.address1 || contact.address2 ? (
              <p className="inline-row-h-21">{formatAddress(contact)}</p>
            ) : (
      ...
      <div className="mt-auto">
        ...
        <div onClick={(e) => e.stopPropagation()}>
          ...
          >
            ...
            <p className="overflow-hidden">{contact.email}</p>
          </button>
        </div>
