...
function Employment({ object, handleGenrateDocument }) {
  ...
  const contact = object?.employment_contact || {};
    ...
    <div className="info-div employment-divs">
        ...
        <div>
          ...
          <div>
            {contact.address1 || contact.address2 ? (
              <span className="fs-14">{formatAddress(contact)}</span>
            ) : (
      ...
      <div className="mt-auto">
        ...
        <a
          ...
          onClick={(e) => {
            handleGenrateDocument(1, "Employment Address");
            e.stopPropagation();
          }}
        >
