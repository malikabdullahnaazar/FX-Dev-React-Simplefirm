...
function PaidRecords({ contact, specialitie, get_providers_edit_modal, handleShow }) {
    return (
        <div className="col-auto c-width-lg-255 w-contact-box d-flex flex-column p-r-5 p-md-r-0">
            <div className="information-wrapper information-wrapper-ch" id="records_request_paid_info">
