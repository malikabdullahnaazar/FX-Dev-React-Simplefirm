...
function RecordReceived({ record_date, contact, specialitie, get_providers_edit_modal, handleShow }) {
    ...
    return (
        <div className="col-auto c-width-lg-255 w-contact-box d-flex flex-column p-r-5 p-md-r-0" id="padding-right-0 ">
            <div className="information-wrapper information-wrapper-ch" id="record_request_info">
                <div data-toggle="modal" data-target="#case-provider-edit-modal"
                    onClick={handleShow}>
                    <div className="has-white-hover text-left p-l-5 p-r-5 p-md-l-0 p-md-r-0">
                        <p
                            className="columnsTitle text-center font-weight-semibold 
                            text-uppercase color-primary">
                            Records Received {record_date ? formatDate(record_date.split("T")[0]) : record_date}
                        </p>
