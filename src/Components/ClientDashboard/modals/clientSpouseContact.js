...
const ModalBodySpouseCon = forwardRef(({ current_first_name, current_last_name, current_address1, current_address2, current_state, current_city, current_zip, handleClose }, ref) => {
    ...
    const getStates = async () => {
        try {
            ...
            console.error("Failed to fetch sates data:", error);
        }
    }
    ...
    useEffect(() => {
        ...
        setValue('firstName', current_first_name);
        setValue('lastName', current_last_name);
...
export default ModalBodySpouseCon;
