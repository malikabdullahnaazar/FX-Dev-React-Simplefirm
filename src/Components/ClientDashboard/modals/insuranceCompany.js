...
const ModalBody = (props) => {
    return (
        <>
            ...
            <p class="p-l-10 p-r-10 p-t-5 p-b-5 client-popup-border text-center" id="">Input and edit the information about the insurance company here.</p>
            <div class="modal-body">
                <form>
                    ...
                    <div className='mt-2'>
                        <Select placeholder="Company" lable="Coverage:" />
                    </div>
                    <div className='mt-2'>
                    ...
                    <div className='mt-2'>
                        <Input placeholder="www.insurancecompany.com" lable="Website URL:" />
                    </div>
                </form>
