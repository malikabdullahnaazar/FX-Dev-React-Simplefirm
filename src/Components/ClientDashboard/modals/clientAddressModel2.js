...
const ModalBodyAddress2 = forwardRef(({id, current_address1, current_address2, current_state, current_city, current_zip, mailing_contact, handleClose }, ref) => {
                            ...
                            <div>
                                <div style={{ paddingLeft: "2rem" }}>
                                    <Form.Check
                                        ...
                                        onChange={(e) => setValue('mail', e.target.checked)}
                                    />
                                </div> 
                            </div>
                        </div>
...
export default ModalBodyAddress2;
