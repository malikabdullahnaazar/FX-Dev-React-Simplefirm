            ...
            <form onSubmit={handleSubmit(onSubmit)} id={`litigation_act_form_${litigationEventMain?.id}`} className="filing_act_form overflow-hidden">
                ...
                <div className="row align-items-center row-gap">
                    ...
                    <div className="col-md-6">
                        <div className="custom-form-field d-flex align-items-center">
                            <label htmlFor="event_select">New Filing:</label>
                    ...
                    <div className="col-md-6">
                        <div className="custom-form-field d-flex align-items-center">
                            <label htmlFor="litigation_act_to">Against:</label>
                    ...
                    <div className="col-md-6">
                        <div className="custom-form-field d-flex align-items-center">
                            <label htmlFor="litigation_act_to">Responding Party:</label>
                            <select {...register('litigation_act_to')} id="litigation_act_to" className="form-control">
                                <option key="" value="">-------</option>
                                {clients?.map(client => (
                                    <option key={client?.id} value={`Client, ${client?.id}`}>{client?.first_name} {client?.last_name} (Client)</option>
                    ...
                    <div className="col-md-6">
                        <div className="custom-form-field d-flex align-items-center">
                            <label htmlFor="litigation_act_to">Moving Party:</label>
                            <select {...register('litigation_act_to')} id="litigation_act_to" className="form-control">
                                <option key="" value="">-------</option>
                                {clients?.map(client => (
                                    <option key={client?.id} value={`Client, ${client?.id}`}>{client?.first_name} {client?.last_name} (Client)</option>
                    ...
                    <div className="col-md-6">
                        <div className="custom-form-field d-flex align-items-center">
                            <label htmlFor="service_method">Service:</label>
                            <select {...register('service_method')} id="service_method" className="form-control">
                                <option value="not_selected" aria-checked="true">Select Method</option>
                                {serviceMethods?.map(service => (
                                    <option key={service?.id} value={service?.id}>{service?.name} + {service?.number_of_days} {service?.day_type} days</option>
                                ))}
                            </select>
                        </div>
                    </div>
...
export default LitigationMotionForm;
