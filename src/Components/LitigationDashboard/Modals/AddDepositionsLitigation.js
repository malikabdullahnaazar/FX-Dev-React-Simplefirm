...
function LitigationDepositionsForm({
    showPopup,
    handleSave,
                    ...
                    <div className="custom-form-field d-flex align-items-center">
                        ...
                        <select {...register('litigation_act_to')} id="litigation_act_to" className="form-control">
                            ...
                            {otherParties?.map(other => (
                                <option key={other?.id} value={`Parties, ${other?.id}`}>{other?.party_first_name} {other?.party_last_name} (Other Party)</option>
                            ))}
...
export default LitigationDepositionsForm;
