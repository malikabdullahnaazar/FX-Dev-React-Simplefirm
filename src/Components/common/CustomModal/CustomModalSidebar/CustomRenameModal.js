...
function CustomRenameModal({ isOpen, documentName, onConfirm, onClose }) {
  if (!isOpen) {
    return null;
  }
...
CustomRenameModal.defaultProps = {
  isOpen: false,
  documentName: "",
  onConfirm: () => {},
  onClose: () => {},
...
export default CustomRenameModal;
