...
function JudgeandDepartmentPopUp({
  showPopup,
  handleClose,
  handleSave,
  handleDelete,
  ...
  }, [current_first_name, current_last_name, current_address1, current_address2, current_city, current_state, current_zip, current_phone, current_fax, current_email, current_department])
  ...
  const onSubmit = async (data) => {
    ...
    const department = normalizeInput(watch("department"));
    ...
    const requestBody = {
      ...
      judge_first_name: fname,
      judge_last_name: lname,
      ...
      <FormProvider {...methods}>
        <div class="modal-content">
          <div class="modal-header text-center">
            <h5 class="modal-title mx-auto">Judge and Department</h5>
          </div>
