function format_phone_fax(phoneNumberInput) {
  ...
  function autocomplete_company_adjuster(inp, arr, arr_2) {
  ...
  function search_filter_company_adjuster(this_element){
      ...
      $.ajax({ 
            ...
            success:function(response){
              ...
              autocomplete_company_adjuster(this_element, response.data, response.data );
